...
<template>
    ...
    <form class="add-form">
        ...
        <input
            type="text"
            name="text"
            placeholder="Adicione o título"
        ...
        <input 
            ...
            />
        <label for="readIt">Já li o livro</label>
        </div>
 
        <button type="submit" @click.prevent="$emit('addBook', newBook)" class="btn btn-block">Salvar livro</button>
    </form>
</template>